	...
	<body class="container">
		...
		<div class="row-fluid">
			...
			<div class="span8">
					  ...
					  <!-- Carousel items -->
					 	<div class="carousel-inner">
					  		<div class="item active">
						    	<a href="#videoadmin"><img src="img/thumbnails/videoadmin.png" alt="videoadmin"></a>
						    	<div class="carousel-caption">
					                  <h4>VideoAdmin</h4>
					                  <p>A ERP prototype for a fictional videocenter franchise</p>
				                </div>
						    </div>
						    <div class="item">						    	
						    	<a href="#LTSP3"><img src="img/thumbnails/260x180.gif" alt="ltsp"></a>
						    	<div class="carousel-caption">
							    	<h4>LTSP3</h4>
					                <p>An LTSP server with virtual machines running Mandriva</p>
				                </div>				                						    	
						    </div>
						    <div class="item">						    	
						    	<a href="#udeg"><img src="img/thumbnails/scolarship.png" alt="udeg"></a>
						    	<div class="carousel-caption">
							    	<h4>Scholaships Unit</h4>					                
							    	<p>Software for administration of scolarships and student exchanges at C.U.C.E.I.</p>
					           </div>						           
					    	</div>
						    <div class="item">						    	
						    	<a href="#sharealla"><img src="img/thumbnails/sharealla.png" alt="sharealla"></a>
						    	<div class="carousel-caption">
							    	<h4>Sharealla</h4>
					                <p>Check-in and share the apps that matter to you</p>
				                </div>
						    </div>
						    <div class="item">						    	
						    	<a href="#html5"><img src="img/thumbnails/html5.png" alt="html5"></a>
						    	<div class="carousel-caption">
							    	<h4>HTML5 training</h4>
					                <p>Final actitivy for the Microsoft HTML5 Developer Fundamentals Training</p>
					           </div>
				          	</div>
						    <div class="item">						    	
						    	<a href="#ceic"><img src="img/thumbnails/NWN.png" alt="ceic"></a>
						    	<div class="carousel-caption">
							    	<h4>NWN Module</h4>
					                <p>A Neverwinter Nights module as part of an investigation regarding decision making at C.E.I.C.</p>
					           </div>
				           </div>
						    <div class="item">						    	
						    	<a href="#memorama"><img src="img/thumbnails/260x180.gif" alt="memorama"></a>
						    	<div class="carousel-caption">
							    	<h4>Memorama</h4>
					                <p>A game based on concentration</p>
					           </div>
				           </div>
						    <div class="item">						    	
						    	<a href="#crossWords"><img src="img/thumbnails/crosswords.png" alt="cross words"></a>
						    	<div class="carousel-caption">
							    	<h4>Cross Words</h4>
					                <p>A console game that allows you to create you own cross words puzzles and solve them</p>
					           </div>
				           </div>							   				           
						    <div class="item">						    	
						    	<a href="#todoList"><img src="img/thumbnails/todolist.png" alt="toDo list"></a>
						    	<div class="carousel-caption">
							    	<h4>ToDo list</h4>
				...
				<p>More info: <a href="www.sharealla.com">www.sharealla.com</a></p>
